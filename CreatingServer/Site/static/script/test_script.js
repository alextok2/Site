...
function Generate() {
    ...
    let url = new URL(window.location.origin + `/api/create_password`)
    ...
    fetch(url, {
        ...
        let modalContent = document.getElementById('modalContent');
        modalContent.innerText = "Новый сгенерированный пароль: " + data.password;
...
function GetData() {
    ...
    let url = new URL(window.location.origin + `/api/edit_role/${id}`)
...
function CreateUser() {
    ...
    fetch(url, {
        ...
        let modalContent = document.getElementById('modalContent');
        modalContent.innerText = "Логин: " + data.login + " Пароль: " + data.password;
    });
}
...
function CreateGroup() {
    ...
    let url = new URL(window.location.origin + `/api/new_group`)
